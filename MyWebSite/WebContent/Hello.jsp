...
<body>
	...
	<form action="/LoginAction" method=post>
		<div class="w3-top">
			<div class="w3-bar w3-white w3-wide w3-padding w3-card">
				<a href=<%=ma%> class="w3-bar-item w3-button" target="_self"><b>JK</b>
					lmnop</a>
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		src="/w3images/architect.jpg" alt="Architecture" width="1500"
		height="800">
	<div class="w3-display-middle w3-margin-top w3-center">
		<h1 class="w3-xxlarge w3-text-white">
			<br> <br> <br> <br> <br> <br> <span
				class="w3-padding w3-black w3-opacity-min"><b>JK</b></span> <span
				class="w3-hide-small w3-text-light-grey"> lmnop </span>
		</h1>
	</div>
	</header>
